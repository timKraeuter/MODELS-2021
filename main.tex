...
The first constraint can be seen as a liveness property, while the last two constraints describe safety properties.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=2.6in]{combined_rule}
...
In addition, more behavioral modeling formalisms must be included to allow for more heterogeneity.

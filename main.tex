...
However, this is not desirable, since the semantic domain should be irrelevant for the user when specifying and checking constraints.
There just has to be a suitable implementation of a semantic domain.
...
I will explain the transformation to graph grammars for state machines, petri nets, and their coordination using a minimal example.

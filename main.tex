...
% 1. Interrelate behavioral models just as with structural models (using for example comprehensive systems). Define metamodels and align them
...
% Consistency checking should be independent of the semantic domain. Maybe just assume some kind of state space getting generated by the semantic domain.

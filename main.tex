...
To the best to our knowledge current approaches only offer limited consistency checking in a heterogeneous scenario.
...
Possible extensions for the given two formalisms would be asynchronous communication, synchronizing multiple Petri net transitions with one state machine transition or a synchronization of more than two transitions from different models.

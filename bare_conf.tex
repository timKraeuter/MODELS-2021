...
There can also arise inconsistencies between structural and behavioral models.
For example x % see proposal
I first want to focus on behavioral consistency before addressing consistency between structural and behavioral models. 
\section{Related work}
% cite the work on behavioral consistency in the mdse field
% cite the work on heterogeneous models / simulation for cyber physical systems (Ptolemy and so on).
